...
C:\Arquiv~1\Postgr~1\8.1\bin\pg_dump -U postgres -f "C:\backup\Luol\Db\PREENCHER NOME DO CLIENTE%Date%.out" PREENCHER NOME DO BANCO DE DADOS
copy "C:\Arquiv~1\Store\Store.exe" "C:\backup\Luol\Exe\Store%Date%.exe"
copy "C:\Arquiv~1\Store\Facil.exe" "C:\backup\Luol\Exe\Facil%Date%.exe"
...
copy "C:\Arquiv~1\Store\Store.exe" "\\NOME DO MICRO DE DESTINO DO BACKUP\backup\Luol\Exe\Store%Date%.exe"
copy "C:\Arquiv~1\Store\Facil.exe" "\\NOME DO MICRO DE DESTINO DO BACKUP\backup\Luol\Exe\Facil%Date%.exe"
