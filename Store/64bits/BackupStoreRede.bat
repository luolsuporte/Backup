...
copy "C:\Program Files (x86)\Store\Store.exe" "C:\backup\Luol\Exe\Store%Date%.exe"
copy "C:\Program Files (x86)\Store\Facil.exe" "C:\backup\Luol\Exe\Facil%Date%.exe"
...
copy "C:\Program Files (x86)\Store\Store.exe" "\\NOME DO MICRO DE DESTINO DO BACKUP\backup\Luol\Exe\Store%Date%.exe"
copy "C:\Program Files (x86)\Store\Facil.exe" "\\NOME DO MICRO DE DESTINO DO BACKUP\backup\Luol\Exe\Facil%Date%.exe"
