...
copy "C:\Progress\Progress.exe" "\\NOME DO MICRO DE DESTINO DO BACKUP\backup\Luol\Exe\Progress%Date%.exe"
copy "C:\Progress\Caixa.exe" "\\NOME DO MICRO DE DESTINO DO BACKUP\backup\Luol\Exe\Caixa%Date%.exe"
