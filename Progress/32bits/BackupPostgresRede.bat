...
copy "C:\Arquiv~1\Progress\Progress.exe" "\\NOME DO MICRO DE DESTINO DO BACKUP\backup\Luol\Exe\Progress%Date%.exe"
copy "C:\Arquiv~1\Progress\Caixa.exe" "\\NOME DO MICRO DE DESTINO DO BACKUP\backup\Luol\Exe\Caixa%Date%.exe"
